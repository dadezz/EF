...
Butflags: removed. we can use directly search on S[] to find the next/previous non-empty bucket, 
...
static_assert(EF<BucketEFSet2>, "BucketEFSet2 does not satisfy EF concept");